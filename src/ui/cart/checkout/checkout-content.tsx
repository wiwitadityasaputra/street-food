...
import "@/src/ui/cart/checkout/checkout.css"
import { CheckoutContentProps, CheckoutContentState } from "@/src/ui/cart/checkout/checkout.definition";
import { formatCurrency } from "@/src/lib/util/utils";
import { processCarts } from "@/src/lib/form-action/cart.action";
...
import {
    ...
    getRandomZipcode
} from '@/src/lib/util/fake-input.util';
