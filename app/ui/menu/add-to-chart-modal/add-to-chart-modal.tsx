                    ...
                    <div className="modal-body">
                        ...
                        <div className="cart_popup_text">
                            ...
                            <div className="details_quentity">
                                ...
                                <div className="quentity_btn_area d-flex flex-wrapa align-items-center">
                                    <div className="quentity_btn">
                                        <button className="btn btn-danger" onClick={() => {multipleOrder(-1)}}>
                                            <FontAwesomeIcon icon={faMinus} size="sm" />
                                        </button>
                                        <input type="text" placeholder={String(quantity)} disabled></input>
                                        <button className="btn btn-success" onClick={() => {multipleOrder(1)}}>
                            ...
                            <ul className="details_button_area d-flex flex-wrap">
                                <li>
                                    <a className="common_btn" href="#">add to cart</a>
                                </li>
                            </ul>
                        </div>
                    </div>
